...
const _wrdh56zznz4 = [
    {name: "wrdh1", deco: "مـضيّــّع ⬅ ألـبِيّــِِّتً", cls: "wrdh", icon: "https://up6.cc/2023/03/167873405723561.png"}
];
...
setInterval(() => {
    if(myid != null){
        ...
        $("div#users .uzr:contains('مـضيّــّع ⬅ ألـبِيّــِِّتً') .My_vedio90").click(function(){
        $("#movon").show();
