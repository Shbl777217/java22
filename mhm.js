...
{dec: "𝐌𝐬𝐡$", cls: "msh_str", icon: "https://up6.cc/2023/04/168133037492731.png"},
...
{dec: "حَياكمّ بـ دكّة شِيبان", cls: "shiban_str", icon: "https://up6.cc/2023/03/167948644970111.gif"}
    ...
    shbl_str_users.forEach(function(user) {
        ...
        if(p_msg.length) {
            p_msg.each(function(index, el) {
               ...
               $(el).find(".fitimg.u-pic").append('<img style="max-width: 77px; margin-top: -12px; margin-left: -14px;" class="itar_shbl" title="اطاري" src="'+user.icon+'">');
            });
        }
    });    
}, 30);
...
#d2 .uzr.shiban_str span.nosel.u-topic.dots.hand{
          
margin-left: 8px !important;
   -webkit-background-clip: text;

  -webkit-text-fill-color: #0000;
 background-image: url(https://up6.cc/2023/04/168202258706881.gif);
...
background-size: cover; 
    ...
    #d2 .uzr.shiban_str .fitimg.u-pic {
        height: 52px !important;
border-radius: 100px; !important; 
...
background-size: cover; 
    ...
    #d2 .uzr.d-flex.mm.shiban_str {
      
  border-radius: 0px 0px 0px 0px;
   
  

 background-image: url(https://up6.cc/2023/04/168202176013971.png);
background-size: 100%;
    }
    #d2 .uzr.shiban_str .itar_shiban  {
        width: 94px;
        height: 94px;
        margin-top: -40px;
        cursor: pointer;
