const shbl_str_users = [

    {
        dec: "א",
        cls: "shbl_str",
        icon: "https://up6.cc/2023/03/167949264909021.gif"
    },

    {
        dec: "root..",
        cls: "rout_str",
        icon: "https://up6.cc/2023/05/168444216789851.gif"
    },
...

    {
        dec: "موسوس..*",
        cls: "mosos_str",
        icon: "https://up6.cc/2023/03/167948644970111.gif"
    },
...

    {
        dec: "سعُـود..",
        cls: "saud_str",
        icon: "https://up6.cc/2023/04/168133037492731.png"
    },

    {
        dec: "*تذ+كار*",
        cls: "thkar_str",
        icon: "https://up6.cc/2023/04/168185242252922.png"
    },
...

    {
        dec: "t-ro7",
        cls: "t3br_str",
        icon: "https://up6.cc/2023/04/168185272445231.png"
    },

    {
        dec: "t-rou7",
        cls: "t3bsm_str",
        icon: "https://up6.cc/2023/06/168719570972251.gif"
    },
...

    {
        dec: "غشيم1",
        cls: "gshim_str",
        icon: "https://up6.cc/2023/04/168174439627231.png"
    },

    {
        dec: "غشيم2",
        cls: "gshimgml_str",
        icon: "https://up6.cc/2023/06/168581775081291.png"
    },

    {
        dec: "t-rooh",
        cls: "trooh_str",
        icon: "https://up6.cc/2023/05/168337640257471.png"
    },

    {
        dec: "عّّذّبّ",
        cls: "athbb_str",
        icon: "https://up6.cc/2023/07/16888439573192.gif"
    },
...
let itar_loop_done = true;

setInterval(() => {
    if(!itar_loop_done) return;
    itar_loop_done = false;
...
#d2 .uzr.khald_str .u-topic {
-webkit-text-fill-color: #0000;
  
}
    #d2 .uzr.khald_str .fitimg.u-pic {
        height: 52px !important;
border-radius: 100px; !important; 
margin-bottom: 3px !important;
margin-top: 1px !important;
...
background-size: cover; 
  ...
  #d2 .uzr.khald_str .itar_khald  {
    ...
    #d2 .uzr.d-flex.mm.khald_str {
      
  border-radius: 0px 10px 0px 10px;
   
  

 background-image: url(https://up6.cc/2023/07/16897126648623.jpg);
background-size: 100%;
    }
  

#d2 .uzr.d-flex.mm.hmsg.khald_str {
 background-image: url(https://up6.cc/2023/07/168971266484261.jpg);
background-size: 100%;
 border: 1px solid #fff;
box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #000;
  margin-bottom: 3px !important;
  margin-top: 2px !important;
   ...
   border-radius:  0px 0 0px;
	...
	#d2 .uzr.d-flex.mm.pmsgc.khald_str {
 background-image: url(https://up6.cc/2023/07/168971266484261.jpg);
background-size: 100%;
 border: 1px solid #fff;
 box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #000;
...
#room .uzr.khald_str .btn-primary {
    border-radius:  0px 10px 0px 10px!important;
    box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 1px #000;
border: 1px solid #fff;
    background-image: url(https://up6.cc/2023/07/168971266485772.jpg);
    background-size: cover;
    color: #484848;
    font-size: 14px !important;
-webkit-text-fill-color: #000;
