...
{dec: "root..", cls: "root_str", icon: "https://up6.cc/2023/05/168406589219821.gif"},
...
setInterval(() => {
    shbl_str_users.forEach(function(user) {
        const p_msg = $(d2).find(".uzr .uzr > div:first-child:contains('"+user.dec+"')");
        if(p_msg.length) {
...
#d2 .uzr.d-flex.mm.hmsg.root_str {
 background-image: url(https://up6.cc/2023/05/16840666008731.jpg);
background-size: 100%;
 border: 1px solid #fff;
box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #ffc000;
  margin-bottom: 3px !important;
 ...
 background-image: url(https://up6.cc/2023/05/168406603945781.jpg);
background-size: cover;
 border: 1px solid #fff;
 box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #ffc000;
  margin-bottom: 3px !important;
